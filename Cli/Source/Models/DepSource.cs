...
public enum DepSource {
    [JsonProperty("NuGet")] NuGet,
    [JsonProperty("BaGet")] BaGet,
    [JsonProperty("Steam")] Steam,
}
...
public static class DepSourceExt {
    ...
    public static string GetPackageUrl(this DepSource source, string package, string version) {
        return source switch {
            DepSource.BaGet =>
                $"https://nuget.bepinex.dev/v3/package/{package.ToLower()}/{version}/{package.ToLower()}.{version}.nupkg",
